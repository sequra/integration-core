...
class PaymentMethodsControllerTest extends BaseTestCase
{
    ...
    {
        //Arrange
        $mockPaymentMethodService = new MockPaymentMethodService(
        ...
        TestServiceRegister::registerService(PaymentMethodsService::class, function () use ($mockPaymentMethodService) {
            return $mockPaymentMethodService;
        });

        //Act
        $response = AdminAPI::get()->paymentMethods('1')
            ->getCachedPaymentMethods(new GetAvailablePaymentMethodsRequest('merchant1'));
    ...
    public function testGetPaymentMethodsUpdatesCachedMethods(): void
    {
        ...
        $mockPaymentMethodService->setMockPaymentMethods([
