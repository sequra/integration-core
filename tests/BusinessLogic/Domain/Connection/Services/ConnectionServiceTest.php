...
class ConnectionServiceTest extends BaseTestCase
{
    ...
    /**
     * @var MockStoreIntegrationService
     */
    protected $mockStoreIntegrationService;
     ...
     * @throws CapabilitiesEmptyException
     */
    public function testConnectIntegrationIdSet(): void
    {
        //Arrange
        $connectionData = new DomainConnectionData(
            BaseProxy::TEST_MODE,
        ...
        $this->connectionService->saveConnectionData($connectionData);
        $this->mockStoreIntegrationService->setMockIntegrationId('integrationId');
        ...
        //Assert
        self::assertEquals('sequra', $result->getDeployment());
        self::assertEquals('integrationId', $result->getIntegrationId());
    }
}
