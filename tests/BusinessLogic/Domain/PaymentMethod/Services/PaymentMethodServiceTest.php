...
namespace SeQura\Core\Tests\BusinessLogic\Domain\PaymentMethod\Services;
...
use SeQura\Core\Tests\BusinessLogic\Common\MockComponents\MockMerchantProxy;
 ...
 *
 * @package SeQura\Core\Tests\BusinessLogic\Domain\PaymentMethod\Services
 */
class PaymentMethodServiceTest extends BaseTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        TestServiceRegister::registerService(PaymentMethodRepositoryInterface::class, function () {
        ...
        $this->service = TestServiceRegister::getService(PaymentMethodsService::class);
    }

    /**
     * @throws Exception
     */
    public function testGetCachedPaymentMethodsNoPaymentMethods(): void
    {
        // act
        $result = StoreContext::doWithStore('1', [$this->service, 'getCachedPaymentMethods'], ['merchant1']);
     ...
     * @throws Exception
     */
    public function testGetCachedPaymentMethodsAlreadyInDatabase(): void
    {
        //arrange
        $this->repository->setMockPaymentMethods($this->generatePaymentMethods());
        ...
        self::assertEquals($this->generatePaymentMethods(), $result);
    }

    /**
     * @throws Exception
     */
    public function testGetCachedPaymentMethodsCachePaymentMethods(): void
    {
        //arrange
        $this->merchantProxy->setMockPaymentMethods($this->generatePaymentMethods());
     ...
     * @throws Exception
     */
    public function testGetMerchantsPaymentMethodsWithCache(): void
    {
        //arrange
        $this->merchantProxy->setMockPaymentMethods($this->generatePaymentMethods());

        // act
        $result = StoreContext::doWithStore('1', [$this->service, 'getMerchantsPaymentMethods'], ['merchant1', true]);

        // assert

        $paymentMethodsFromDatabase = $this->repository->getPaymentMethods('merchant1');
        self::assertCount(3, $result);
        self::assertEquals($this->generatePaymentMethods(), $result);
        self::assertEquals($this->generatePaymentMethods(), $paymentMethodsFromDatabase);
    }

    /**
     * @throws Exception
     */
    public function testGetMerchantsPaymentMethodsWithCacheRemoveDepricated(): void
    {
        //arrange
        $this->repository->setMockPaymentMethods([
            new SeQuraPaymentMethod(
                'i11',
                'Paga Después1',
                'Paga después. 7 días desde el envío1',
                'pay_later',
