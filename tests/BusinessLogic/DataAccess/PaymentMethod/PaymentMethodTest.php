...
namespace BusinessLogic\DataAccess\PaymentMethod;
...
class PaymentMethodTest extends BaseTestCase
{
    ...
    public function testSettersAndGetters(): void
    {
        ...
        $paymentMethod->setProduct('i1');
        $paymentMethod->setStoreId('1');
        $paymentMethod->setMerchantId('test');
        $paymentMethod->setSeQuraPaymentMethod($seQuraPaymentMethod);

        $this->assertEquals('i1', $paymentMethod->getProduct());
        $this->assertEquals('1', $paymentMethod->getStoreId());
        $this->assertEquals('test', $paymentMethod->getMerchantId());
        $this->assertEquals($seQuraPaymentMethod, $paymentMethod->getSeQuraPaymentMethod());
    }
    ...
    public function testInflateAndToArray(): void
    {
        $data = [
            ...
            'seQuraPaymentMethod' =>  [
                ...
                'starts_at' => '2000-02-22 21:22:00',
                'ends_at' => '2222-02-22 21:22:00',
                'campaign' => null,
        ...
        $paymentMethod = new PaymentMethod();
        $paymentMethod->inflate($data);

        $this->assertEquals($data['storeId'], $paymentMethod->toArray()['storeId']);
        $this->assertEquals($data['merchantId'], $paymentMethod->toArray()['merchantId']);
        $this->assertEquals($data['product'], $paymentMethod->toArray()['product']);
        $this->assertEquals($data['seQuraPaymentMethod'], $paymentMethod->toArray()['seQuraPaymentMethod']);
    }
}
