...
class PaymentMethodsRepositoryTest extends BaseTestCase
{
    /**
    ...
    protected function setUp(): void
    {
        ...
        $this->repository = TestServiceRegister::getService(PaymentMethodRepositoryInterface::class);
    ...
    public function testGetPaymentMethodsCount()
    {
        StoreContext::doWithStore('1', function() {
            ...
            $this->repository->setPaymentMethod('test', $seQuraPaymentMethod);
            $paymentMethods = $this->repository->getPaymentMethods('test');
            self::assertEquals(2, count($paymentMethods));
        });
    }
    ...
    public function testGetPaymentMethodByProduct()
    {
        StoreContext::doWithStore('1', function() {
            ...
            self::assertEquals('i1', $paymentMethod->getProduct());
        });
    }
    ...
    public function testDeletePaymentMethod()
    {
        StoreContext::doWithStore('1', function() {
            ...
            $this->repository->deletePaymentMethod($seQuraPaymentMethod);

            $paymentMethods = $this->repository->getPaymentMethods('test');

            self::assertEquals(0, count($paymentMethods));
        });
    }
}
