...
/**
 * Class InvalidLocationHeaderException.
 *
 * @package SeQura\Core\BusinessLogic\Domain\StoreIntegration\Exceptions
 */
class InvalidLocationHeaderException extends BaseTranslatableException
{
    /**
     * @var int
     */
    ...
    public function __construct(?Throwable $previous = null)
    {
        parent::__construct(new TranslatableLabel(
            ...
            'general.errors.storeIntegration.invalidLocationHeader'
        ), $previous);
    }
}
