...
/**
 * Class CurlHttpClientService. In charge of doing an HTTP request by using cURL library.
 *
...
class CurlHttpClient extends HttpClient
{
     ...
     * @return void
     */
    protected function sendHttpRequestAsync(string $method, string $url, ?array $headers = array(), string $body = ''): void
    {
        $this->setCurlSessionAndCommonRequestParts($method, $url, $headers, $body);
